...
import { Laugh, Phone, Video, Image, Camera, Mic, SendHorizontal, EllipsisVertical, HardDriveDownload } from "lucide-react"
      ...
      otherUser ? (
        ...
        <div className="h-full flex flex-col flex-2 items-center justify-center border border-transparent border-l-slate-600 border-r-slate-600 select-none">
          <div className="flex flex-col items-center gap-3">
            <img src={logoimg} style={{borderRadius: '50%', width: '200px'}}></img>
            <h1 className="text-lg font-semibold">Desire Dail</h1>
